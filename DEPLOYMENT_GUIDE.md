...
7.  **`NEXT_PUBLIC_ADMIN_EMAILS`**: Una lista de correos electrónicos, separados por comas y sin espacios, que tendrán acceso al panel de administración (ej: `admin1@example.com,admin2@example.com`).
